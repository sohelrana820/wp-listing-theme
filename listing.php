		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/vencer_sarthe_supercar.jpg" alt="vencer_sarthe_supercar" class="img-responsive">
						</div>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/audi_q7_2017.jpg" alt="audi-q7-2017" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header  s-lineDownLeft">
								<h3>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/mercedes_benz_c_class.jpg" alt="mercedes_benz_c_class" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header  s-lineDownLeft">
								<h3>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/mclaren_650S.jpg" alt="mclaren_650S" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header  s-lineDownLeft">
								<h3>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/bmw_emw_m3_diski_serie.jpg" alt="bmw_emw_m3_diski_serie" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header s-lineDownLeft">
								<h3>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/lamborghini_2016.jpg" alt="lamborghini_2016" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header s-lineDownLeft">
								<h3>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/porsche_cayen_cast.jpg" alt="porsche_cayen-cast" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header s-lineDownLeft">
								<h3>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/jaguar_f_type_r.jpg" alt="jaguar_f_type_r" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header s-lineDownLeft">
								<h3>
				...
				<div class="list-car-box">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 list-car-pic clearfix">
							<img src="img/lists/range_rover_2016.jpg" alt="jaguar_f_type_r" class="img-responsive">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 car-content clearfix">
							<div class="header b-items-cars-one-info-header s-lineDownLeft">
								<h3>
